...
#count how many repeat of the nums above
...
# find where the letter number is on the index
...
for i in range(len(months)):
    n = (months [i], numbers[i]) # this builds each tuple with each loop
    year.append(n) # appends our empty list

for months , numbers in year:
    print(f'{months} is month {numbers} of the year')
