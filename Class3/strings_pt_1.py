...
# numbs_or_no = user_input.isdigit()
...
'''
# comments = input("What's the word? ")
# comments_2 = (input("What's the number? ")) # Get our inputs from user
# comments = comments.strip()

# the_length = len(comments)
# the_variables = (comments > comments_2)

# print(f'does {comments} have more words than {comments_2}? {the_variables}')
